...
(function(){
  ...
  window.openWebView = function(opts){
    ...
    try{ if(window.oaiStoreFoldSurface && !restore) window.oaiStoreFoldSurface({type:'web'}, 'openWebView'); }catch(_e){}
    if(!restore){
  ...
  window.openTrailView = function(opts){
    const restore = !!(opts&&opts.restore);
    try{ if(window.oaiStoreFoldSurface && !restore) window.oaiStoreFoldSurface({type:'trail'}, 'openTrailView'); }catch(_e){}
