...
(function(){
  ...
  function getHantiRouteData(){
    // V8-1-14-618: 한티가는길 내부 네비게이션을 앱에서 제거한다.
  ...
  function isHantiTrailItem(d){
    // V8-1-14-618: 한티가는길 전용 네비게이션/전체경로보기 진입 차단.
    return false;
  }
  ...
  function restoreHantiRouteIfActive(){
    // V8-1-14-618: 한티가는길 내부 네비게이션 제거. 이전 저장 상태가 남아 있어도 복원하지 않는다.
  ...
  window.trailMyLoc = function(){
    ...
    /* V8-1-14-618: 기존에는 maximumAge:60000 저정확 위치를 먼저 표시한 뒤
