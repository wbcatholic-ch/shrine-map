...
(function(){
  'use strict';
  if(window.__APP_PULL_REFRESH_CLEAN_V13__) return;
  window.__APP_PULL_REFRESH_CLEAN_V13__ = true;
  ...
  function installPullRefresh(){
    var cover=$('cover'), ind=$('cv-pull-modern');
    if(!cover || !ind || cover.__oaiPullRefreshCleanV13) return;
    cover.__oaiPullRefreshCleanV13 = true;
