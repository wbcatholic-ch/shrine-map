...
(function(){
  'use strict';
  if(window.__APP_PULL_REFRESH_CLEAN_V25__) return;
  window.__APP_PULL_REFRESH_CLEAN_V25__ = true;
  ...
  function installPullRefresh(){
    var cover=$('cover'), ind=$('cv-pull-modern');
    if(!cover || !ind || cover.__oaiPullRefreshCleanV25) return;
    cover.__oaiPullRefreshCleanV25 = true;
