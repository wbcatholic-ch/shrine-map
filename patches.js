...
(function(){
  'use strict';
  if(window.__APP_PULL_REFRESH_CLEAN_V11__) return;
  window.__APP_PULL_REFRESH_CLEAN_V11__ = true;
  ...
  function installPullRefresh(){
    var cover=$('cover'), ind=$('cv-pull-modern');
    if(!cover || !ind || cover.__oaiPullRefreshCleanV11) return;
    cover.__oaiPullRefreshCleanV11 = true;
