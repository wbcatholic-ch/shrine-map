const CACHE_VERSION = 'catholic-way-WebView-Clean-95';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-95',
  './core.js?v=WebView-Clean-95',
  './style.css?v=WebView-Clean-95',
  './app.js?v=WebView-Clean-95',
  './diocese-meta.js?v=WebView-Clean-95',
  './diocese-search.js?v=WebView-Clean-95',
  './diocese-data.js?v=WebView-Clean-95',
  './diocese-ui.js?v=WebView-Clean-95',
  './web.js?v=WebView-Clean-95',
  './patches.js?v=WebView-Clean-95',
  './sw-update.js?v=WebView-Clean-95',
  './manifest.json?v=WebView-Clean-95',
  './intro-cross-jesus.jpg?v=WebView-Clean-95',
  './icon-192x192.png',
  './icon-512x512.png',
