const CACHE_VERSION = 'catholic-way-WebView-Clean-50';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-50',
  './core.js?v=WebView-Clean-50',
  './style.css?v=WebView-Clean-50',
  './app.js?v=WebView-Clean-50',
  './diocese-meta.js?v=WebView-Clean-50',
  './diocese-search.js?v=WebView-Clean-50',
  './diocese-data.js?v=WebView-Clean-50',
  './diocese-ui.js?v=WebView-Clean-50',
  './web.js?v=WebView-Clean-50',
  './patches.js?v=WebView-Clean-50',
  './sw-update.js?v=WebView-Clean-50',
  './manifest.json?v=WebView-Clean-50',
  './intro-cross-jesus.jpg?v=WebView-Clean-50',
  './icon-192x192.png',
  './icon-512x512.png',
