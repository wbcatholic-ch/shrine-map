const CACHE_VERSION = 'catholic-way-WebView-Clean-1';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-1',
  './core.js?v=WebView-Clean-1',
  './style.css?v=WebView-Clean-1',
  './app.js?v=WebView-Clean-1',
  './diocese-meta.js?v=WebView-Clean-1',
  './diocese-search.js?v=WebView-Clean-1',
  './diocese-data.js?v=WebView-Clean-1',
  './diocese-ui.js?v=WebView-Clean-1',
  './web.js?v=WebView-Clean-1',
  './patches.js?v=WebView-Clean-1',
  './sw-update.js?v=WebView-Clean-1',
  './manifest.json?v=WebView-Clean-1',
  './intro-cross-jesus.jpg?v=WebView-Clean-1',
'./icon-192x192.png',
  './icon-512x512.png',
