const CACHE_VERSION = 'catholic-way-WebView-Clean-53';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-53',
  './core.js?v=WebView-Clean-53',
  './style.css?v=WebView-Clean-53',
  './app.js?v=WebView-Clean-53',
  './diocese-meta.js?v=WebView-Clean-53',
  './diocese-search.js?v=WebView-Clean-53',
  './diocese-data.js?v=WebView-Clean-53',
  './diocese-ui.js?v=WebView-Clean-53',
  './web.js?v=WebView-Clean-53',
  './patches.js?v=WebView-Clean-53',
  './sw-update.js?v=WebView-Clean-53',
  './manifest.json?v=WebView-Clean-53',
  './intro-cross-jesus.jpg?v=WebView-Clean-53',
  './icon-192x192.png',
  './icon-512x512.png',
