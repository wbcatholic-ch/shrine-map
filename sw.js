const CACHE_VERSION = 'catholic-way-WebView-Clean-22';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-22',
  './core.js?v=WebView-Clean-22',
  './style.css?v=WebView-Clean-22',
  './app.js?v=WebView-Clean-22',
  './diocese-meta.js?v=WebView-Clean-22',
  './diocese-search.js?v=WebView-Clean-22',
  './diocese-data.js?v=WebView-Clean-22',
  './diocese-ui.js?v=WebView-Clean-22',
  './web.js?v=WebView-Clean-22',
  './patches.js?v=WebView-Clean-22',
  './sw-update.js?v=WebView-Clean-22',
  './manifest.json?v=WebView-Clean-22',
  './intro-cross-jesus.jpg?v=WebView-Clean-22',
  './icon-192x192.png',
  './icon-512x512.png',
