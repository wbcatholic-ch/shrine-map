const CACHE_VERSION = 'catholic-way-WebView-Clean-49';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-49',
  './core.js?v=WebView-Clean-49',
  './style.css?v=WebView-Clean-49',
  './app.js?v=WebView-Clean-49',
  './diocese-meta.js?v=WebView-Clean-49',
  './diocese-search.js?v=WebView-Clean-49',
  './diocese-data.js?v=WebView-Clean-49',
  './diocese-ui.js?v=WebView-Clean-49',
  './web.js?v=WebView-Clean-49',
  './patches.js?v=WebView-Clean-49',
  './sw-update.js?v=WebView-Clean-49',
  './manifest.json?v=WebView-Clean-49',
  './intro-cross-jesus.jpg?v=WebView-Clean-49',
  './icon-192x192.png',
  './icon-512x512.png',
