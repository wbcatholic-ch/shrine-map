const CACHE_VERSION = 'catholic-way-WebView-Clean-27';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-27',
  './core.js?v=WebView-Clean-27',
  './style.css?v=WebView-Clean-27',
  './app.js?v=WebView-Clean-27',
  './diocese-meta.js?v=WebView-Clean-27',
  './diocese-search.js?v=WebView-Clean-27',
  './diocese-data.js?v=WebView-Clean-27',
  './diocese-ui.js?v=WebView-Clean-27',
  './web.js?v=WebView-Clean-27',
  './patches.js?v=WebView-Clean-27',
  './sw-update.js?v=WebView-Clean-27',
  './manifest.json?v=WebView-Clean-27',
  './intro-cross-jesus.jpg?v=WebView-Clean-27',
  './icon-192x192.png',
  './icon-512x512.png',
