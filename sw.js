const CACHE_VERSION = 'catholic-way-WebView-Clean-37';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-37',
  './core.js?v=WebView-Clean-37',
  './style.css?v=WebView-Clean-37',
  './app.js?v=WebView-Clean-37',
  './diocese-meta.js?v=WebView-Clean-37',
  './diocese-search.js?v=WebView-Clean-37',
  './diocese-data.js?v=WebView-Clean-37',
  './diocese-ui.js?v=WebView-Clean-37',
  './web.js?v=WebView-Clean-37',
  './patches.js?v=WebView-Clean-37',
  './sw-update.js?v=WebView-Clean-37',
  './manifest.json?v=WebView-Clean-37',
  './intro-cross-jesus.jpg?v=WebView-Clean-37',
  './icon-192x192.png',
  './icon-512x512.png',
