const CACHE_VERSION = 'catholic-way-WebView-Clean-70';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-70',
  './core.js?v=WebView-Clean-70',
  './style.css?v=WebView-Clean-70',
  './app.js?v=WebView-Clean-70',
  './diocese-meta.js?v=WebView-Clean-70',
  './diocese-search.js?v=WebView-Clean-70',
  './diocese-data.js?v=WebView-Clean-70',
  './diocese-ui.js?v=WebView-Clean-70',
  './web.js?v=WebView-Clean-70',
  './patches.js?v=WebView-Clean-70',
  './sw-update.js?v=WebView-Clean-70',
  './manifest.json?v=WebView-Clean-70',
  './intro-cross-jesus.jpg?v=WebView-Clean-70',
  './icon-192x192.png',
  './icon-512x512.png',
