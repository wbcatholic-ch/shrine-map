const CACHE_VERSION = 'catholic-way-WebView-Clean-113';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-113',
  './core.js?v=WebView-Clean-113',
  './style.css?v=WebView-Clean-113',
  './app.js?v=WebView-Clean-113',
  './diocese-meta.js?v=WebView-Clean-113',
  './diocese-search.js?v=WebView-Clean-113',
  './diocese-data.js?v=WebView-Clean-113',
  './diocese-ui.js?v=WebView-Clean-113',
  './web.js?v=WebView-Clean-113',
  './patches.js?v=WebView-Clean-113',
  './sw-update.js?v=WebView-Clean-113',
  './manifest.json?v=WebView-Clean-113',
  './intro-cross-jesus.jpg?v=WebView-Clean-113',
  './icon-192x192.png',
  './icon-512x512.png',
