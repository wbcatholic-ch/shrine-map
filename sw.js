const CACHE_VERSION = 'catholic-way-WebView-Clean-42';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-42',
  './core.js?v=WebView-Clean-42',
  './style.css?v=WebView-Clean-42',
  './app.js?v=WebView-Clean-42',
  './diocese-meta.js?v=WebView-Clean-42',
  './diocese-search.js?v=WebView-Clean-42',
  './diocese-data.js?v=WebView-Clean-42',
  './diocese-ui.js?v=WebView-Clean-42',
  './web.js?v=WebView-Clean-42',
  './patches.js?v=WebView-Clean-42',
  './sw-update.js?v=WebView-Clean-42',
  './manifest.json?v=WebView-Clean-42',
  './intro-cross-jesus.jpg?v=WebView-Clean-42',
  './icon-192x192.png',
  './icon-512x512.png',
