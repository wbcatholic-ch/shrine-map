const CACHE_VERSION = 'catholic-way-WebView-Clean-57';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-57',
  './core.js?v=WebView-Clean-57',
  './style.css?v=WebView-Clean-57',
  './app.js?v=WebView-Clean-57',
  './diocese-meta.js?v=WebView-Clean-57',
  './diocese-search.js?v=WebView-Clean-57',
  './diocese-data.js?v=WebView-Clean-57',
  './diocese-ui.js?v=WebView-Clean-57',
  './web.js?v=WebView-Clean-57',
  './patches.js?v=WebView-Clean-57',
  './sw-update.js?v=WebView-Clean-57',
  './manifest.json?v=WebView-Clean-57',
  './intro-cross-jesus.jpg?v=WebView-Clean-57',
  './icon-192x192.png',
  './icon-512x512.png',
