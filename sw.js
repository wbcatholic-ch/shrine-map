const CACHE_VERSION = 'catholic-way-WebView-Clean-120';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-120',
  './core.js?v=WebView-Clean-120',
  './style.css?v=WebView-Clean-120',
  './app.js?v=WebView-Clean-120',
  './diocese-meta.js?v=WebView-Clean-120',
  './diocese-search.js?v=WebView-Clean-120',
  './diocese-data.js?v=WebView-Clean-120',
  './diocese-ui.js?v=WebView-Clean-120',
  './web.js?v=WebView-Clean-120',
  './patches.js?v=WebView-Clean-120',
  './sw-update.js?v=WebView-Clean-120',
  './manifest.json?v=WebView-Clean-120',
  './intro-cross-jesus.jpg?v=WebView-Clean-120',
  './icon-192x192.png',
  './icon-512x512.png',
