const CACHE_VERSION = 'catholic-way-WebView-Clean-39';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-39',
  './core.js?v=WebView-Clean-39',
  './style.css?v=WebView-Clean-39',
  './app.js?v=WebView-Clean-39',
  './diocese-meta.js?v=WebView-Clean-39',
  './diocese-search.js?v=WebView-Clean-39',
  './diocese-data.js?v=WebView-Clean-39',
  './diocese-ui.js?v=WebView-Clean-39',
  './web.js?v=WebView-Clean-39',
  './patches.js?v=WebView-Clean-39',
  './sw-update.js?v=WebView-Clean-39',
  './manifest.json?v=WebView-Clean-39',
  './intro-cross-jesus.jpg?v=WebView-Clean-39',
  './icon-192x192.png',
  './icon-512x512.png',
