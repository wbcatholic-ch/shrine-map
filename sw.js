const CACHE_VERSION = 'catholic-way-WebView-Clean-105';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-105',
  './core.js?v=WebView-Clean-105',
  './style.css?v=WebView-Clean-105',
  './app.js?v=WebView-Clean-105',
  './diocese-meta.js?v=WebView-Clean-105',
  './diocese-search.js?v=WebView-Clean-105',
  './diocese-data.js?v=WebView-Clean-105',
  './diocese-ui.js?v=WebView-Clean-105',
  './web.js?v=WebView-Clean-105',
  './patches.js?v=WebView-Clean-105',
  './sw-update.js?v=WebView-Clean-105',
  './manifest.json?v=WebView-Clean-105',
  './intro-cross-jesus.jpg?v=WebView-Clean-105',
  './icon-192x192.png',
  './icon-512x512.png',
