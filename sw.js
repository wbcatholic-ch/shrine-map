const CACHE_VERSION = 'catholic-way-WebView-Clean-16';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-16',
  './core.js?v=WebView-Clean-16',
  './style.css?v=WebView-Clean-16',
  './app.js?v=WebView-Clean-16',
  './diocese-meta.js?v=WebView-Clean-16',
  './diocese-search.js?v=WebView-Clean-16',
  './diocese-data.js?v=WebView-Clean-16',
  './diocese-ui.js?v=WebView-Clean-16',
  './web.js?v=WebView-Clean-16',
  './patches.js?v=WebView-Clean-16',
  './sw-update.js?v=WebView-Clean-16',
  './manifest.json?v=WebView-Clean-16',
  './intro-cross-jesus.jpg?v=WebView-Clean-16',
  './icon-192x192.png',
  './icon-512x512.png',
