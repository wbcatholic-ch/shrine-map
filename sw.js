const CACHE_VERSION = 'catholic-way-WebView-Clean-78';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-78',
  './core.js?v=WebView-Clean-78',
  './style.css?v=WebView-Clean-78',
  './app.js?v=WebView-Clean-78',
  './diocese-meta.js?v=WebView-Clean-78',
  './diocese-search.js?v=WebView-Clean-78',
  './diocese-data.js?v=WebView-Clean-78',
  './diocese-ui.js?v=WebView-Clean-78',
  './web.js?v=WebView-Clean-78',
  './patches.js?v=WebView-Clean-78',
  './sw-update.js?v=WebView-Clean-78',
  './manifest.json?v=WebView-Clean-78',
  './intro-cross-jesus.jpg?v=WebView-Clean-78',
  './icon-192x192.png',
  './icon-512x512.png',
