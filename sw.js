const CACHE_VERSION = 'catholic-way-WebView-Clean-117';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-117',
  './core.js?v=WebView-Clean-117',
  './style.css?v=WebView-Clean-117',
  './app.js?v=WebView-Clean-117',
  './diocese-meta.js?v=WebView-Clean-117',
  './diocese-search.js?v=WebView-Clean-117',
  './diocese-data.js?v=WebView-Clean-117',
  './diocese-ui.js?v=WebView-Clean-117',
  './web.js?v=WebView-Clean-117',
  './patches.js?v=WebView-Clean-117',
  './sw-update.js?v=WebView-Clean-117',
  './manifest.json?v=WebView-Clean-117',
  './intro-cross-jesus.jpg?v=WebView-Clean-117',
  './icon-192x192.png',
  './icon-512x512.png',
