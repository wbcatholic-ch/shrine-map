const CACHE_VERSION = 'catholic-way-WebView-Clean-77';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-77',
  './core.js?v=WebView-Clean-77',
  './style.css?v=WebView-Clean-77',
  './app.js?v=WebView-Clean-77',
  './diocese-meta.js?v=WebView-Clean-77',
  './diocese-search.js?v=WebView-Clean-77',
  './diocese-data.js?v=WebView-Clean-77',
  './diocese-ui.js?v=WebView-Clean-77',
  './web.js?v=WebView-Clean-77',
  './patches.js?v=WebView-Clean-77',
  './sw-update.js?v=WebView-Clean-77',
  './manifest.json?v=WebView-Clean-77',
  './intro-cross-jesus.jpg?v=WebView-Clean-77',
  './icon-192x192.png',
  './icon-512x512.png',
