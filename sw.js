const CACHE_VERSION = 'catholic-way-WebView-Clean-43';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-43',
  './core.js?v=WebView-Clean-43',
  './style.css?v=WebView-Clean-43',
  './app.js?v=WebView-Clean-43',
  './diocese-meta.js?v=WebView-Clean-43',
  './diocese-search.js?v=WebView-Clean-43',
  './diocese-data.js?v=WebView-Clean-43',
  './diocese-ui.js?v=WebView-Clean-43',
  './web.js?v=WebView-Clean-43',
  './patches.js?v=WebView-Clean-43',
  './sw-update.js?v=WebView-Clean-43',
  './manifest.json?v=WebView-Clean-43',
  './intro-cross-jesus.jpg?v=WebView-Clean-43',
  './icon-192x192.png',
  './icon-512x512.png',
