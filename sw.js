const CACHE_VERSION = 'catholic-way-WebView-Clean-106';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-106',
  './core.js?v=WebView-Clean-106',
  './style.css?v=WebView-Clean-106',
  './app.js?v=WebView-Clean-106',
  './diocese-meta.js?v=WebView-Clean-106',
  './diocese-search.js?v=WebView-Clean-106',
  './diocese-data.js?v=WebView-Clean-106',
  './diocese-ui.js?v=WebView-Clean-106',
  './web.js?v=WebView-Clean-106',
  './patches.js?v=WebView-Clean-106',
  './sw-update.js?v=WebView-Clean-106',
  './manifest.json?v=WebView-Clean-106',
  './intro-cross-jesus.jpg?v=WebView-Clean-106',
  './icon-192x192.png',
  './icon-512x512.png',
