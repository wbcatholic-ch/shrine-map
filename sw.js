const CACHE_VERSION = 'catholic-way-WebView-Clean-100';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-100',
  './core.js?v=WebView-Clean-100',
  './style.css?v=WebView-Clean-100',
  './app.js?v=WebView-Clean-100',
  './diocese-meta.js?v=WebView-Clean-100',
  './diocese-search.js?v=WebView-Clean-100',
  './diocese-data.js?v=WebView-Clean-100',
  './diocese-ui.js?v=WebView-Clean-100',
  './web.js?v=WebView-Clean-100',
  './patches.js?v=WebView-Clean-100',
  './sw-update.js?v=WebView-Clean-100',
  './manifest.json?v=WebView-Clean-100',
  './intro-cross-jesus.jpg?v=WebView-Clean-100',
  './icon-192x192.png',
  './icon-512x512.png',
