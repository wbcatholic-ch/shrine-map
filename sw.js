const CACHE_VERSION = 'catholic-way-WebView-Clean-55';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-55',
  './core.js?v=WebView-Clean-55',
  './style.css?v=WebView-Clean-55',
  './app.js?v=WebView-Clean-55',
  './diocese-meta.js?v=WebView-Clean-55',
  './diocese-search.js?v=WebView-Clean-55',
  './diocese-data.js?v=WebView-Clean-55',
  './diocese-ui.js?v=WebView-Clean-55',
  './web.js?v=WebView-Clean-55',
  './patches.js?v=WebView-Clean-55',
  './sw-update.js?v=WebView-Clean-55',
  './manifest.json?v=WebView-Clean-55',
  './intro-cross-jesus.jpg?v=WebView-Clean-55',
  './icon-192x192.png',
  './icon-512x512.png',
