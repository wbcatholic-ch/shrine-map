const CACHE_VERSION = 'catholic-way-WebView-Clean-107';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-107',
  './core.js?v=WebView-Clean-107',
  './style.css?v=WebView-Clean-107',
  './app.js?v=WebView-Clean-107',
  './diocese-meta.js?v=WebView-Clean-107',
  './diocese-search.js?v=WebView-Clean-107',
  './diocese-data.js?v=WebView-Clean-107',
  './diocese-ui.js?v=WebView-Clean-107',
  './web.js?v=WebView-Clean-107',
  './patches.js?v=WebView-Clean-107',
  './sw-update.js?v=WebView-Clean-107',
  './manifest.json?v=WebView-Clean-107',
  './intro-cross-jesus.jpg?v=WebView-Clean-107',
  './icon-192x192.png',
  './icon-512x512.png',
