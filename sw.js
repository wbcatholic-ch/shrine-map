const CACHE_VERSION = 'catholic-way-WebView-Clean-2';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-2',
  './core.js?v=WebView-Clean-2',
  './style.css?v=WebView-Clean-2',
  './app.js?v=WebView-Clean-2',
  './diocese-meta.js?v=WebView-Clean-2',
  './diocese-search.js?v=WebView-Clean-2',
  './diocese-data.js?v=WebView-Clean-2',
  './diocese-ui.js?v=WebView-Clean-2',
  './web.js?v=WebView-Clean-2',
  './patches.js?v=WebView-Clean-2',
  './sw-update.js?v=WebView-Clean-2',
  './manifest.json?v=WebView-Clean-2',
  './intro-cross-jesus.jpg?v=WebView-Clean-2',
'./icon-192x192.png',
  './icon-512x512.png',
