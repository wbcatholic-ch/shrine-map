const CACHE_VERSION = 'catholic-way-WebView-Clean-80';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-80',
  './core.js?v=WebView-Clean-80',
  './style.css?v=WebView-Clean-80',
  './app.js?v=WebView-Clean-80',
  './diocese-meta.js?v=WebView-Clean-80',
  './diocese-search.js?v=WebView-Clean-80',
  './diocese-data.js?v=WebView-Clean-80',
  './diocese-ui.js?v=WebView-Clean-80',
  './web.js?v=WebView-Clean-80',
  './patches.js?v=WebView-Clean-80',
  './sw-update.js?v=WebView-Clean-80',
  './manifest.json?v=WebView-Clean-80',
  './intro-cross-jesus.jpg?v=WebView-Clean-80',
  './icon-192x192.png',
  './icon-512x512.png',
