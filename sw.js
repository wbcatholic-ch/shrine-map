const CACHE_VERSION = 'catholic-way-WebView-Clean-84';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-84',
  './core.js?v=WebView-Clean-84',
  './style.css?v=WebView-Clean-84',
  './app.js?v=WebView-Clean-84',
  './diocese-meta.js?v=WebView-Clean-84',
  './diocese-search.js?v=WebView-Clean-84',
  './diocese-data.js?v=WebView-Clean-84',
  './diocese-ui.js?v=WebView-Clean-84',
  './web.js?v=WebView-Clean-84',
  './patches.js?v=WebView-Clean-84',
  './sw-update.js?v=WebView-Clean-84',
  './manifest.json?v=WebView-Clean-84',
  './intro-cross-jesus.jpg?v=WebView-Clean-84',
  './icon-192x192.png',
  './icon-512x512.png',
