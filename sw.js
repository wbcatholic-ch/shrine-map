const CACHE_VERSION = 'catholic-way-WebView-Clean-82';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-82',
  './core.js?v=WebView-Clean-82',
  './style.css?v=WebView-Clean-82',
  './app.js?v=WebView-Clean-82',
  './diocese-meta.js?v=WebView-Clean-82',
  './diocese-search.js?v=WebView-Clean-82',
  './diocese-data.js?v=WebView-Clean-82',
  './diocese-ui.js?v=WebView-Clean-82',
  './web.js?v=WebView-Clean-82',
  './patches.js?v=WebView-Clean-82',
  './sw-update.js?v=WebView-Clean-82',
  './manifest.json?v=WebView-Clean-82',
  './intro-cross-jesus.jpg?v=WebView-Clean-82',
  './icon-192x192.png',
  './icon-512x512.png',
