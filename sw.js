...
const CACHE_VERSION = 'catholic-way-V2-146';
/* 다이어트 1: 첫 실행에 꼭 필요한 앱 셸만 선캐시합니다.
   성당/성지/피정의집/기도문/관구교구/문의 페이지는 versioned fetch 시 cacheFirst로 저장됩니다. */
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=V2-146',
  './core.js?v=V2-146',
  './style.css?v=V2-146',
  './app.js?v=V2-146',
  './diocese-meta.js?v=V2-146',
  './diocese-search.js?v=V2-146',
  './diocese-data.js?v=V2-146',
  './diocese-ui.js?v=V2-146',
  './web.js?v=V2-146',
  './patches.js?v=V2-146',
  './sw-update.js?v=V2-146',
  './manifest.json?v=V2-146',
  './intro-cross-jesus.jpg?v=V2-146',
'./icon-192x192.png',
  './icon-512x512.png',
