const CACHE_VERSION = 'catholic-way-WebView-Clean-99';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-99',
  './core.js?v=WebView-Clean-99',
  './style.css?v=WebView-Clean-99',
  './app.js?v=WebView-Clean-99',
  './diocese-meta.js?v=WebView-Clean-99',
  './diocese-search.js?v=WebView-Clean-99',
  './diocese-data.js?v=WebView-Clean-99',
  './diocese-ui.js?v=WebView-Clean-99',
  './web.js?v=WebView-Clean-99',
  './patches.js?v=WebView-Clean-99',
  './sw-update.js?v=WebView-Clean-99',
  './manifest.json?v=WebView-Clean-99',
  './intro-cross-jesus.jpg?v=WebView-Clean-99',
  './icon-192x192.png',
  './icon-512x512.png',
