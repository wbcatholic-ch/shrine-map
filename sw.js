const CACHE_VERSION = 'catholic-way-WebView-Clean-93';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-93',
  './core.js?v=WebView-Clean-93',
  './style.css?v=WebView-Clean-93',
  './app.js?v=WebView-Clean-93',
  './diocese-meta.js?v=WebView-Clean-93',
  './diocese-search.js?v=WebView-Clean-93',
  './diocese-data.js?v=WebView-Clean-93',
  './diocese-ui.js?v=WebView-Clean-93',
  './web.js?v=WebView-Clean-93',
  './patches.js?v=WebView-Clean-93',
  './sw-update.js?v=WebView-Clean-93',
  './manifest.json?v=WebView-Clean-93',
  './intro-cross-jesus.jpg?v=WebView-Clean-93',
  './icon-192x192.png',
  './icon-512x512.png',
