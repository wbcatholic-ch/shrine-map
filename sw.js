const CACHE_VERSION = 'catholic-way-WebView-Clean-30';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-30',
  './core.js?v=WebView-Clean-30',
  './style.css?v=WebView-Clean-30',
  './app.js?v=WebView-Clean-30',
  './diocese-meta.js?v=WebView-Clean-30',
  './diocese-search.js?v=WebView-Clean-30',
  './diocese-data.js?v=WebView-Clean-30',
  './diocese-ui.js?v=WebView-Clean-30',
  './web.js?v=WebView-Clean-30',
  './patches.js?v=WebView-Clean-30',
  './sw-update.js?v=WebView-Clean-30',
  './manifest.json?v=WebView-Clean-30',
  './intro-cross-jesus.jpg?v=WebView-Clean-30',
  './icon-192x192.png',
  './icon-512x512.png',
