const CACHE_VERSION = 'catholic-way-WebView-Clean-38';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-38',
  './core.js?v=WebView-Clean-38',
  './style.css?v=WebView-Clean-38',
  './app.js?v=WebView-Clean-38',
  './diocese-meta.js?v=WebView-Clean-38',
  './diocese-search.js?v=WebView-Clean-38',
  './diocese-data.js?v=WebView-Clean-38',
  './diocese-ui.js?v=WebView-Clean-38',
  './web.js?v=WebView-Clean-38',
  './patches.js?v=WebView-Clean-38',
  './sw-update.js?v=WebView-Clean-38',
  './manifest.json?v=WebView-Clean-38',
  './intro-cross-jesus.jpg?v=WebView-Clean-38',
  './icon-192x192.png',
  './icon-512x512.png',
