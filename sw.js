const CACHE_VERSION = 'catholic-way-WebView-Clean-25';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-25',
  './core.js?v=WebView-Clean-25',
  './style.css?v=WebView-Clean-25',
  './app.js?v=WebView-Clean-25',
  './diocese-meta.js?v=WebView-Clean-25',
  './diocese-search.js?v=WebView-Clean-25',
  './diocese-data.js?v=WebView-Clean-25',
  './diocese-ui.js?v=WebView-Clean-25',
  './web.js?v=WebView-Clean-25',
  './patches.js?v=WebView-Clean-25',
  './sw-update.js?v=WebView-Clean-25',
  './manifest.json?v=WebView-Clean-25',
  './intro-cross-jesus.jpg?v=WebView-Clean-25',
  './icon-192x192.png',
  './icon-512x512.png',
