...
const CACHE_VERSION = 'catholic-way-V2-161';
/* 다이어트 1: 첫 실행에 꼭 필요한 앱 셸만 선캐시합니다.
   성당/성지/피정의집/기도문/관구교구/문의 페이지는 versioned fetch 시 cacheFirst로 저장됩니다. */
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=V2-161',
  './core.js?v=V2-161',
  './style.css?v=V2-161',
  './app.js?v=V2-161',
  './diocese-meta.js?v=V2-161',
  './diocese-search.js?v=V2-161',
  './diocese-data.js?v=V2-161',
  './diocese-ui.js?v=V2-161',
  './web.js?v=V2-161',
  './patches.js?v=V2-161',
  './sw-update.js?v=V2-161',
  './manifest.json?v=V2-161',
  './intro-cross-jesus.jpg?v=V2-161',
'./icon-192x192.png',
  './icon-512x512.png',
