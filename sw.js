const CACHE_VERSION = 'catholic-way-WebView-Clean-26';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-26',
  './core.js?v=WebView-Clean-26',
  './style.css?v=WebView-Clean-26',
  './app.js?v=WebView-Clean-26',
  './diocese-meta.js?v=WebView-Clean-26',
  './diocese-search.js?v=WebView-Clean-26',
  './diocese-data.js?v=WebView-Clean-26',
  './diocese-ui.js?v=WebView-Clean-26',
  './web.js?v=WebView-Clean-26',
  './patches.js?v=WebView-Clean-26',
  './sw-update.js?v=WebView-Clean-26',
  './manifest.json?v=WebView-Clean-26',
  './intro-cross-jesus.jpg?v=WebView-Clean-26',
  './icon-192x192.png',
  './icon-512x512.png',
