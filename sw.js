const CACHE_VERSION = 'catholic-way-WebView-Clean-116';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-116',
  './core.js?v=WebView-Clean-116',
  './style.css?v=WebView-Clean-116',
  './app.js?v=WebView-Clean-116',
  './diocese-meta.js?v=WebView-Clean-116',
  './diocese-search.js?v=WebView-Clean-116',
  './diocese-data.js?v=WebView-Clean-116',
  './diocese-ui.js?v=WebView-Clean-116',
  './web.js?v=WebView-Clean-116',
  './patches.js?v=WebView-Clean-116',
  './sw-update.js?v=WebView-Clean-116',
  './manifest.json?v=WebView-Clean-116',
  './intro-cross-jesus.jpg?v=WebView-Clean-116',
  './icon-192x192.png',
  './icon-512x512.png',
