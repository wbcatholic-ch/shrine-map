const CACHE_VERSION = 'catholic-way-WebView-Clean-23';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-23',
  './core.js?v=WebView-Clean-23',
  './style.css?v=WebView-Clean-23',
  './app.js?v=WebView-Clean-23',
  './diocese-meta.js?v=WebView-Clean-23',
  './diocese-search.js?v=WebView-Clean-23',
  './diocese-data.js?v=WebView-Clean-23',
  './diocese-ui.js?v=WebView-Clean-23',
  './web.js?v=WebView-Clean-23',
  './patches.js?v=WebView-Clean-23',
  './sw-update.js?v=WebView-Clean-23',
  './manifest.json?v=WebView-Clean-23',
  './intro-cross-jesus.jpg?v=WebView-Clean-23',
  './icon-192x192.png',
  './icon-512x512.png',
