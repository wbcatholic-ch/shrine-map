const CACHE_VERSION = 'catholic-way-WebView-Clean-75';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-75',
  './core.js?v=WebView-Clean-75',
  './style.css?v=WebView-Clean-75',
  './app.js?v=WebView-Clean-75',
  './diocese-meta.js?v=WebView-Clean-75',
  './diocese-search.js?v=WebView-Clean-75',
  './diocese-data.js?v=WebView-Clean-75',
  './diocese-ui.js?v=WebView-Clean-75',
  './web.js?v=WebView-Clean-75',
  './patches.js?v=WebView-Clean-75',
  './sw-update.js?v=WebView-Clean-75',
  './manifest.json?v=WebView-Clean-75',
  './intro-cross-jesus.jpg?v=WebView-Clean-75',
  './icon-192x192.png',
  './icon-512x512.png',
