const CACHE_VERSION = 'catholic-way-WebView-Clean-40';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-40',
  './core.js?v=WebView-Clean-40',
  './style.css?v=WebView-Clean-40',
  './app.js?v=WebView-Clean-40',
  './diocese-meta.js?v=WebView-Clean-40',
  './diocese-search.js?v=WebView-Clean-40',
  './diocese-data.js?v=WebView-Clean-40',
  './diocese-ui.js?v=WebView-Clean-40',
  './web.js?v=WebView-Clean-40',
  './patches.js?v=WebView-Clean-40',
  './sw-update.js?v=WebView-Clean-40',
  './manifest.json?v=WebView-Clean-40',
  './intro-cross-jesus.jpg?v=WebView-Clean-40',
  './icon-192x192.png',
  './icon-512x512.png',
