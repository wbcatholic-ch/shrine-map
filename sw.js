const CACHE_VERSION = 'catholic-way-WebView-Clean-24';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-24',
  './core.js?v=WebView-Clean-24',
  './style.css?v=WebView-Clean-24',
  './app.js?v=WebView-Clean-24',
  './diocese-meta.js?v=WebView-Clean-24',
  './diocese-search.js?v=WebView-Clean-24',
  './diocese-data.js?v=WebView-Clean-24',
  './diocese-ui.js?v=WebView-Clean-24',
  './web.js?v=WebView-Clean-24',
  './patches.js?v=WebView-Clean-24',
  './sw-update.js?v=WebView-Clean-24',
  './manifest.json?v=WebView-Clean-24',
  './intro-cross-jesus.jpg?v=WebView-Clean-24',
  './icon-192x192.png',
  './icon-512x512.png',
