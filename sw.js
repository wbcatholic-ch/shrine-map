const CACHE_VERSION = 'catholic-way-WebView-Clean-35';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-35',
  './core.js?v=WebView-Clean-35',
  './style.css?v=WebView-Clean-35',
  './app.js?v=WebView-Clean-35',
  './diocese-meta.js?v=WebView-Clean-35',
  './diocese-search.js?v=WebView-Clean-35',
  './diocese-data.js?v=WebView-Clean-35',
  './diocese-ui.js?v=WebView-Clean-35',
  './web.js?v=WebView-Clean-35',
  './patches.js?v=WebView-Clean-35',
  './sw-update.js?v=WebView-Clean-35',
  './manifest.json?v=WebView-Clean-35',
  './intro-cross-jesus.jpg?v=WebView-Clean-35',
  './icon-192x192.png',
  './icon-512x512.png',
