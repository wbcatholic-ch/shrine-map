const CACHE_VERSION = 'catholic-way-WebView-Clean-76';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-76',
  './core.js?v=WebView-Clean-76',
  './style.css?v=WebView-Clean-76',
  './app.js?v=WebView-Clean-76',
  './diocese-meta.js?v=WebView-Clean-76',
  './diocese-search.js?v=WebView-Clean-76',
  './diocese-data.js?v=WebView-Clean-76',
  './diocese-ui.js?v=WebView-Clean-76',
  './web.js?v=WebView-Clean-76',
  './patches.js?v=WebView-Clean-76',
  './sw-update.js?v=WebView-Clean-76',
  './manifest.json?v=WebView-Clean-76',
  './intro-cross-jesus.jpg?v=WebView-Clean-76',
  './icon-192x192.png',
  './icon-512x512.png',
