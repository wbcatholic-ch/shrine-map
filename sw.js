const CACHE_VERSION = 'catholic-way-WebView-Clean-13';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-13',
  './core.js?v=WebView-Clean-13',
  './style.css?v=WebView-Clean-13',
  './app.js?v=WebView-Clean-13',
  './diocese-meta.js?v=WebView-Clean-13',
  './diocese-search.js?v=WebView-Clean-13',
  './diocese-data.js?v=WebView-Clean-13',
  './diocese-ui.js?v=WebView-Clean-13',
  './web.js?v=WebView-Clean-13',
  './patches.js?v=WebView-Clean-13',
  './sw-update.js?v=WebView-Clean-13',
  './manifest.json?v=WebView-Clean-13',
  './intro-cross-jesus.jpg?v=WebView-Clean-13',
  './icon-192x192.png',
  './icon-512x512.png',
