const CACHE_VERSION = 'catholic-way-WebView-Clean-19';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-19',
  './core.js?v=WebView-Clean-19',
  './style.css?v=WebView-Clean-19',
  './app.js?v=WebView-Clean-19',
  './diocese-meta.js?v=WebView-Clean-19',
  './diocese-search.js?v=WebView-Clean-19',
  './diocese-data.js?v=WebView-Clean-19',
  './diocese-ui.js?v=WebView-Clean-19',
  './web.js?v=WebView-Clean-19',
  './patches.js?v=WebView-Clean-19',
  './sw-update.js?v=WebView-Clean-19',
  './manifest.json?v=WebView-Clean-19',
  './intro-cross-jesus.jpg?v=WebView-Clean-19',
  './icon-192x192.png',
  './icon-512x512.png',
