const CACHE_VERSION = 'catholic-way-WebView-Clean-103';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-103',
  './core.js?v=WebView-Clean-103',
  './style.css?v=WebView-Clean-103',
  './app.js?v=WebView-Clean-103',
  './diocese-meta.js?v=WebView-Clean-103',
  './diocese-search.js?v=WebView-Clean-103',
  './diocese-data.js?v=WebView-Clean-103',
  './diocese-ui.js?v=WebView-Clean-103',
  './web.js?v=WebView-Clean-103',
  './patches.js?v=WebView-Clean-103',
  './sw-update.js?v=WebView-Clean-103',
  './manifest.json?v=WebView-Clean-103',
  './intro-cross-jesus.jpg?v=WebView-Clean-103',
  './icon-192x192.png',
  './icon-512x512.png',
