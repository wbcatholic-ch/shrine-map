const CACHE_VERSION = 'catholic-way-WebView-Clean-79';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-79',
  './core.js?v=WebView-Clean-79',
  './style.css?v=WebView-Clean-79',
  './app.js?v=WebView-Clean-79',
  './diocese-meta.js?v=WebView-Clean-79',
  './diocese-search.js?v=WebView-Clean-79',
  './diocese-data.js?v=WebView-Clean-79',
  './diocese-ui.js?v=WebView-Clean-79',
  './web.js?v=WebView-Clean-79',
  './patches.js?v=WebView-Clean-79',
  './sw-update.js?v=WebView-Clean-79',
  './manifest.json?v=WebView-Clean-79',
  './intro-cross-jesus.jpg?v=WebView-Clean-79',
  './icon-192x192.png',
  './icon-512x512.png',
