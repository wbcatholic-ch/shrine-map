const CACHE_VERSION = 'catholic-way-WebView-Clean-59';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-59',
  './core.js?v=WebView-Clean-59',
  './style.css?v=WebView-Clean-59',
  './app.js?v=WebView-Clean-59',
  './diocese-meta.js?v=WebView-Clean-59',
  './diocese-search.js?v=WebView-Clean-59',
  './diocese-data.js?v=WebView-Clean-59',
  './diocese-ui.js?v=WebView-Clean-59',
  './web.js?v=WebView-Clean-59',
  './patches.js?v=WebView-Clean-59',
  './sw-update.js?v=WebView-Clean-59',
  './manifest.json?v=WebView-Clean-59',
  './intro-cross-jesus.jpg?v=WebView-Clean-59',
  './icon-192x192.png',
  './icon-512x512.png',
