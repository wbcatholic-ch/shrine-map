const CACHE_VERSION = 'catholic-way-WebView-Clean-88';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-88',
  './core.js?v=WebView-Clean-88',
  './style.css?v=WebView-Clean-88',
  './app.js?v=WebView-Clean-88',
  './diocese-meta.js?v=WebView-Clean-88',
  './diocese-search.js?v=WebView-Clean-88',
  './diocese-data.js?v=WebView-Clean-88',
  './diocese-ui.js?v=WebView-Clean-88',
  './web.js?v=WebView-Clean-88',
  './patches.js?v=WebView-Clean-88',
  './sw-update.js?v=WebView-Clean-88',
  './manifest.json?v=WebView-Clean-88',
  './intro-cross-jesus.jpg?v=WebView-Clean-88',
  './icon-192x192.png',
  './icon-512x512.png',
