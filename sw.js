const CACHE_VERSION = 'catholic-way-WebView-Clean-56';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-56',
  './core.js?v=WebView-Clean-56',
  './style.css?v=WebView-Clean-56',
  './app.js?v=WebView-Clean-56',
  './diocese-meta.js?v=WebView-Clean-56',
  './diocese-search.js?v=WebView-Clean-56',
  './diocese-data.js?v=WebView-Clean-56',
  './diocese-ui.js?v=WebView-Clean-56',
  './web.js?v=WebView-Clean-56',
  './patches.js?v=WebView-Clean-56',
  './sw-update.js?v=WebView-Clean-56',
  './manifest.json?v=WebView-Clean-56',
  './intro-cross-jesus.jpg?v=WebView-Clean-56',
  './icon-192x192.png',
  './icon-512x512.png',
