const CACHE_VERSION = 'catholic-way-WebView-Clean-45';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-45',
  './core.js?v=WebView-Clean-45',
  './style.css?v=WebView-Clean-45',
  './app.js?v=WebView-Clean-45',
  './diocese-meta.js?v=WebView-Clean-45',
  './diocese-search.js?v=WebView-Clean-45',
  './diocese-data.js?v=WebView-Clean-45',
  './diocese-ui.js?v=WebView-Clean-45',
  './web.js?v=WebView-Clean-45',
  './patches.js?v=WebView-Clean-45',
  './sw-update.js?v=WebView-Clean-45',
  './manifest.json?v=WebView-Clean-45',
  './intro-cross-jesus.jpg?v=WebView-Clean-45',
  './icon-192x192.png',
  './icon-512x512.png',
