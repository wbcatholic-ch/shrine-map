const CACHE_VERSION = 'catholic-way-WebView-Clean-15';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-15',
  './core.js?v=WebView-Clean-15',
  './style.css?v=WebView-Clean-15',
  './app.js?v=WebView-Clean-15',
  './diocese-meta.js?v=WebView-Clean-15',
  './diocese-search.js?v=WebView-Clean-15',
  './diocese-data.js?v=WebView-Clean-15',
  './diocese-ui.js?v=WebView-Clean-15',
  './web.js?v=WebView-Clean-15',
  './patches.js?v=WebView-Clean-15',
  './sw-update.js?v=WebView-Clean-15',
  './manifest.json?v=WebView-Clean-15',
  './intro-cross-jesus.jpg?v=WebView-Clean-15',
  './icon-192x192.png',
  './icon-512x512.png',
