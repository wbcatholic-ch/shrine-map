const CACHE_VERSION = 'catholic-way-WebView-Clean-28';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-28',
  './core.js?v=WebView-Clean-28',
  './style.css?v=WebView-Clean-28',
  './app.js?v=WebView-Clean-28',
  './diocese-meta.js?v=WebView-Clean-28',
  './diocese-search.js?v=WebView-Clean-28',
  './diocese-data.js?v=WebView-Clean-28',
  './diocese-ui.js?v=WebView-Clean-28',
  './web.js?v=WebView-Clean-28',
  './patches.js?v=WebView-Clean-28',
  './sw-update.js?v=WebView-Clean-28',
  './manifest.json?v=WebView-Clean-28',
  './intro-cross-jesus.jpg?v=WebView-Clean-28',
  './icon-192x192.png',
  './icon-512x512.png',
