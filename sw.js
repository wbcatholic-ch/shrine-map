const CACHE_VERSION = 'catholic-way-WebView-Clean-18';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-18',
  './core.js?v=WebView-Clean-18',
  './style.css?v=WebView-Clean-18',
  './app.js?v=WebView-Clean-18',
  './diocese-meta.js?v=WebView-Clean-18',
  './diocese-search.js?v=WebView-Clean-18',
  './diocese-data.js?v=WebView-Clean-18',
  './diocese-ui.js?v=WebView-Clean-18',
  './web.js?v=WebView-Clean-18',
  './patches.js?v=WebView-Clean-18',
  './sw-update.js?v=WebView-Clean-18',
  './manifest.json?v=WebView-Clean-18',
  './intro-cross-jesus.jpg?v=WebView-Clean-18',
  './icon-192x192.png',
  './icon-512x512.png',
