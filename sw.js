const CACHE_VERSION = 'catholic-way-WebView-Clean-34';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-34',
  './core.js?v=WebView-Clean-34',
  './style.css?v=WebView-Clean-34',
  './app.js?v=WebView-Clean-34',
  './diocese-meta.js?v=WebView-Clean-34',
  './diocese-search.js?v=WebView-Clean-34',
  './diocese-data.js?v=WebView-Clean-34',
  './diocese-ui.js?v=WebView-Clean-34',
  './web.js?v=WebView-Clean-34',
  './patches.js?v=WebView-Clean-34',
  './sw-update.js?v=WebView-Clean-34',
  './manifest.json?v=WebView-Clean-34',
  './intro-cross-jesus.jpg?v=WebView-Clean-34',
  './icon-192x192.png',
  './icon-512x512.png',
