const CACHE_VERSION = 'catholic-way-WebView-Clean-12';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-12',
  './core.js?v=WebView-Clean-12',
  './style.css?v=WebView-Clean-12',
  './app.js?v=WebView-Clean-12',
  './diocese-meta.js?v=WebView-Clean-12',
  './diocese-search.js?v=WebView-Clean-12',
  './diocese-data.js?v=WebView-Clean-12',
  './diocese-ui.js?v=WebView-Clean-12',
  './web.js?v=WebView-Clean-12',
  './patches.js?v=WebView-Clean-12',
  './sw-update.js?v=WebView-Clean-12',
  './manifest.json?v=WebView-Clean-12',
  './intro-cross-jesus.jpg?v=WebView-Clean-12',
  './icon-192x192.png',
  './icon-512x512.png',
