const CACHE_VERSION = 'catholic-way-WebView-Clean-54';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-54',
  './core.js?v=WebView-Clean-54',
  './style.css?v=WebView-Clean-54',
  './app.js?v=WebView-Clean-54',
  './diocese-meta.js?v=WebView-Clean-54',
  './diocese-search.js?v=WebView-Clean-54',
  './diocese-data.js?v=WebView-Clean-54',
  './diocese-ui.js?v=WebView-Clean-54',
  './web.js?v=WebView-Clean-54',
  './patches.js?v=WebView-Clean-54',
  './sw-update.js?v=WebView-Clean-54',
  './manifest.json?v=WebView-Clean-54',
  './intro-cross-jesus.jpg?v=WebView-Clean-54',
  './icon-192x192.png',
  './icon-512x512.png',
