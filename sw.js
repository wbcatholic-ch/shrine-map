const CACHE_VERSION = 'catholic-way-WebView-Clean-109';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-109',
  './core.js?v=WebView-Clean-109',
  './style.css?v=WebView-Clean-109',
  './app.js?v=WebView-Clean-109',
  './diocese-meta.js?v=WebView-Clean-109',
  './diocese-search.js?v=WebView-Clean-109',
  './diocese-data.js?v=WebView-Clean-109',
  './diocese-ui.js?v=WebView-Clean-109',
  './web.js?v=WebView-Clean-109',
  './patches.js?v=WebView-Clean-109',
  './sw-update.js?v=WebView-Clean-109',
  './manifest.json?v=WebView-Clean-109',
  './intro-cross-jesus.jpg?v=WebView-Clean-109',
  './icon-192x192.png',
  './icon-512x512.png',
