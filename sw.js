const CACHE_VERSION = 'catholic-way-WebView-Clean-17';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-17',
  './core.js?v=WebView-Clean-17',
  './style.css?v=WebView-Clean-17',
  './app.js?v=WebView-Clean-17',
  './diocese-meta.js?v=WebView-Clean-17',
  './diocese-search.js?v=WebView-Clean-17',
  './diocese-data.js?v=WebView-Clean-17',
  './diocese-ui.js?v=WebView-Clean-17',
  './web.js?v=WebView-Clean-17',
  './patches.js?v=WebView-Clean-17',
  './sw-update.js?v=WebView-Clean-17',
  './manifest.json?v=WebView-Clean-17',
  './intro-cross-jesus.jpg?v=WebView-Clean-17',
  './icon-192x192.png',
  './icon-512x512.png',
