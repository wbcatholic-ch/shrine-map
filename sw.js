...
const CACHE_VERSION = 'catholic-way-V2-135';
/* 다이어트 1: 첫 실행에 꼭 필요한 앱 셸만 선캐시합니다.
   성당/성지/피정의집/기도문/관구교구/문의 페이지는 versioned fetch 시 cacheFirst로 저장됩니다. */
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=V2-135',
  './core.js?v=V2-135',
  './style.css?v=V2-135',
  './app.js?v=V2-135',
  './diocese-meta.js?v=V2-135',
  './diocese-search.js?v=V2-135',
  './diocese-data.js?v=V2-135',
  './diocese-style.css?v=V2-135',
  './diocese-ui.js?v=V2-135',
  './web.js?v=V2-135',
  './patches.js?v=V2-135',
  './sw-update.js?v=V2-135',
  './manifest.json?v=V2-135',
  './intro-cross-jesus.jpg?v=V2-135',
'./icon-192x192.png',
  './icon-512x512.png',
...
function isVersionedAsset(request) {
  try {
    ...
    return url.searchParams.has('v') ||
      /parishes(?:-[a-z-]+)?\.js|prayer\.js|retreats\.js|shrines\.js|diocese\.html|diocese-style\.css|qa-firebase\.html|app\.js|style\.css|web\.js|patches\.js|sw-update\.js/.test(url.pathname);
