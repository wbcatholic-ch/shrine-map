const CACHE_VERSION = 'catholic-way-WebView-Clean-91';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-91',
  './core.js?v=WebView-Clean-91',
  './style.css?v=WebView-Clean-91',
  './app.js?v=WebView-Clean-91',
  './diocese-meta.js?v=WebView-Clean-91',
  './diocese-search.js?v=WebView-Clean-91',
  './diocese-data.js?v=WebView-Clean-91',
  './diocese-ui.js?v=WebView-Clean-91',
  './web.js?v=WebView-Clean-91',
  './patches.js?v=WebView-Clean-91',
  './sw-update.js?v=WebView-Clean-91',
  './manifest.json?v=WebView-Clean-91',
  './intro-cross-jesus.jpg?v=WebView-Clean-91',
  './icon-192x192.png',
  './icon-512x512.png',
