const CACHE_VERSION = 'catholic-way-WebView-Clean-124';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-124',
  './core.js?v=WebView-Clean-124',
  './style.css?v=WebView-Clean-124',
  './app.js?v=WebView-Clean-124',
  './diocese-meta.js?v=WebView-Clean-124',
  './diocese-search.js?v=WebView-Clean-124',
  './diocese-data.js?v=WebView-Clean-124',
  './diocese-ui.js?v=WebView-Clean-124',
  './web.js?v=WebView-Clean-124',
  './patches.js?v=WebView-Clean-124',
  './sw-update.js?v=WebView-Clean-124',
  './manifest.json?v=WebView-Clean-124',
  './intro-cross-jesus.jpg?v=WebView-Clean-124',
  './icon-192x192.png',
  './icon-512x512.png',
