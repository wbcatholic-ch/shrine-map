const CACHE_VERSION = 'catholic-way-WebView-Clean-92';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-92',
  './core.js?v=WebView-Clean-92',
  './style.css?v=WebView-Clean-92',
  './app.js?v=WebView-Clean-92',
  './diocese-meta.js?v=WebView-Clean-92',
  './diocese-search.js?v=WebView-Clean-92',
  './diocese-data.js?v=WebView-Clean-92',
  './diocese-ui.js?v=WebView-Clean-92',
  './web.js?v=WebView-Clean-92',
  './patches.js?v=WebView-Clean-92',
  './sw-update.js?v=WebView-Clean-92',
  './manifest.json?v=WebView-Clean-92',
  './intro-cross-jesus.jpg?v=WebView-Clean-92',
  './icon-192x192.png',
  './icon-512x512.png',
