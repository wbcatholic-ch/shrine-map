const CACHE_VERSION = 'catholic-way-WebView-Clean-29';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-29',
  './core.js?v=WebView-Clean-29',
  './style.css?v=WebView-Clean-29',
  './app.js?v=WebView-Clean-29',
  './diocese-meta.js?v=WebView-Clean-29',
  './diocese-search.js?v=WebView-Clean-29',
  './diocese-data.js?v=WebView-Clean-29',
  './diocese-ui.js?v=WebView-Clean-29',
  './web.js?v=WebView-Clean-29',
  './patches.js?v=WebView-Clean-29',
  './sw-update.js?v=WebView-Clean-29',
  './manifest.json?v=WebView-Clean-29',
  './intro-cross-jesus.jpg?v=WebView-Clean-29',
  './icon-192x192.png',
  './icon-512x512.png',
