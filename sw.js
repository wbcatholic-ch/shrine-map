const CACHE_VERSION = 'catholic-way-WebView-Clean-86';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-86',
  './core.js?v=WebView-Clean-86',
  './style.css?v=WebView-Clean-86',
  './app.js?v=WebView-Clean-86',
  './diocese-meta.js?v=WebView-Clean-86',
  './diocese-search.js?v=WebView-Clean-86',
  './diocese-data.js?v=WebView-Clean-86',
  './diocese-ui.js?v=WebView-Clean-86',
  './web.js?v=WebView-Clean-86',
  './patches.js?v=WebView-Clean-86',
  './sw-update.js?v=WebView-Clean-86',
  './manifest.json?v=WebView-Clean-86',
  './intro-cross-jesus.jpg?v=WebView-Clean-86',
  './icon-192x192.png',
  './icon-512x512.png',
