const CACHE_VERSION = 'catholic-way-WebView-Clean-47';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-47',
  './core.js?v=WebView-Clean-47',
  './style.css?v=WebView-Clean-47',
  './app.js?v=WebView-Clean-47',
  './diocese-meta.js?v=WebView-Clean-47',
  './diocese-search.js?v=WebView-Clean-47',
  './diocese-data.js?v=WebView-Clean-47',
  './diocese-ui.js?v=WebView-Clean-47',
  './web.js?v=WebView-Clean-47',
  './patches.js?v=WebView-Clean-47',
  './sw-update.js?v=WebView-Clean-47',
  './manifest.json?v=WebView-Clean-47',
  './intro-cross-jesus.jpg?v=WebView-Clean-47',
  './icon-192x192.png',
  './icon-512x512.png',
