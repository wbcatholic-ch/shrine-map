const CACHE_VERSION = 'catholic-way-WebView-Clean-102';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-102',
  './core.js?v=WebView-Clean-102',
  './style.css?v=WebView-Clean-102',
  './app.js?v=WebView-Clean-102',
  './diocese-meta.js?v=WebView-Clean-102',
  './diocese-search.js?v=WebView-Clean-102',
  './diocese-data.js?v=WebView-Clean-102',
  './diocese-ui.js?v=WebView-Clean-102',
  './web.js?v=WebView-Clean-102',
  './patches.js?v=WebView-Clean-102',
  './sw-update.js?v=WebView-Clean-102',
  './manifest.json?v=WebView-Clean-102',
  './intro-cross-jesus.jpg?v=WebView-Clean-102',
  './icon-192x192.png',
  './icon-512x512.png',
