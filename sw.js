const CACHE_VERSION = 'catholic-way-WebView-Clean-89';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-89',
  './core.js?v=WebView-Clean-89',
  './style.css?v=WebView-Clean-89',
  './app.js?v=WebView-Clean-89',
  './diocese-meta.js?v=WebView-Clean-89',
  './diocese-search.js?v=WebView-Clean-89',
  './diocese-data.js?v=WebView-Clean-89',
  './diocese-ui.js?v=WebView-Clean-89',
  './web.js?v=WebView-Clean-89',
  './patches.js?v=WebView-Clean-89',
  './sw-update.js?v=WebView-Clean-89',
  './manifest.json?v=WebView-Clean-89',
  './intro-cross-jesus.jpg?v=WebView-Clean-89',
  './icon-192x192.png',
  './icon-512x512.png',
