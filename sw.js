const CACHE_VERSION = 'catholic-way-WebView-Clean-31';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-31',
  './core.js?v=WebView-Clean-31',
  './style.css?v=WebView-Clean-31',
  './app.js?v=WebView-Clean-31',
  './diocese-meta.js?v=WebView-Clean-31',
  './diocese-search.js?v=WebView-Clean-31',
  './diocese-data.js?v=WebView-Clean-31',
  './diocese-ui.js?v=WebView-Clean-31',
  './web.js?v=WebView-Clean-31',
  './patches.js?v=WebView-Clean-31',
  './sw-update.js?v=WebView-Clean-31',
  './manifest.json?v=WebView-Clean-31',
  './intro-cross-jesus.jpg?v=WebView-Clean-31',
  './icon-192x192.png',
  './icon-512x512.png',
