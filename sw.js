const CACHE_VERSION = 'catholic-way-WebView-Clean-98';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-98',
  './core.js?v=WebView-Clean-98',
  './style.css?v=WebView-Clean-98',
  './app.js?v=WebView-Clean-98',
  './diocese-meta.js?v=WebView-Clean-98',
  './diocese-search.js?v=WebView-Clean-98',
  './diocese-data.js?v=WebView-Clean-98',
  './diocese-ui.js?v=WebView-Clean-98',
  './web.js?v=WebView-Clean-98',
  './patches.js?v=WebView-Clean-98',
  './sw-update.js?v=WebView-Clean-98',
  './manifest.json?v=WebView-Clean-98',
  './intro-cross-jesus.jpg?v=WebView-Clean-98',
  './icon-192x192.png',
  './icon-512x512.png',
