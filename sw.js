const CACHE_VERSION = 'catholic-way-WebView-Clean-63';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-63',
  './core.js?v=WebView-Clean-63',
  './style.css?v=WebView-Clean-63',
  './app.js?v=WebView-Clean-63',
  './diocese-meta.js?v=WebView-Clean-63',
  './diocese-search.js?v=WebView-Clean-63',
  './diocese-data.js?v=WebView-Clean-63',
  './diocese-ui.js?v=WebView-Clean-63',
  './web.js?v=WebView-Clean-63',
  './patches.js?v=WebView-Clean-63',
  './sw-update.js?v=WebView-Clean-63',
  './manifest.json?v=WebView-Clean-63',
  './intro-cross-jesus.jpg?v=WebView-Clean-63',
  './icon-192x192.png',
  './icon-512x512.png',
