const CACHE_VERSION = 'catholic-way-WebView-Clean-60';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-60',
  './core.js?v=WebView-Clean-60',
  './style.css?v=WebView-Clean-60',
  './app.js?v=WebView-Clean-60',
  './diocese-meta.js?v=WebView-Clean-60',
  './diocese-search.js?v=WebView-Clean-60',
  './diocese-data.js?v=WebView-Clean-60',
  './diocese-ui.js?v=WebView-Clean-60',
  './web.js?v=WebView-Clean-60',
  './patches.js?v=WebView-Clean-60',
  './sw-update.js?v=WebView-Clean-60',
  './manifest.json?v=WebView-Clean-60',
  './intro-cross-jesus.jpg?v=WebView-Clean-60',
  './icon-192x192.png',
  './icon-512x512.png',
