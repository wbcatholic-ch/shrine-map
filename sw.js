const CACHE_VERSION = 'catholic-way-WebView-Clean-110';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-110',
  './core.js?v=WebView-Clean-110',
  './style.css?v=WebView-Clean-110',
  './app.js?v=WebView-Clean-110',
  './diocese-meta.js?v=WebView-Clean-110',
  './diocese-search.js?v=WebView-Clean-110',
  './diocese-data.js?v=WebView-Clean-110',
  './diocese-ui.js?v=WebView-Clean-110',
  './web.js?v=WebView-Clean-110',
  './patches.js?v=WebView-Clean-110',
  './sw-update.js?v=WebView-Clean-110',
  './manifest.json?v=WebView-Clean-110',
  './intro-cross-jesus.jpg?v=WebView-Clean-110',
  './icon-192x192.png',
  './icon-512x512.png',
