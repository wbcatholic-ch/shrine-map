const CACHE_VERSION = 'catholic-way-WebView-Clean-101';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-101',
  './core.js?v=WebView-Clean-101',
  './style.css?v=WebView-Clean-101',
  './app.js?v=WebView-Clean-101',
  './diocese-meta.js?v=WebView-Clean-101',
  './diocese-search.js?v=WebView-Clean-101',
  './diocese-data.js?v=WebView-Clean-101',
  './diocese-ui.js?v=WebView-Clean-101',
  './web.js?v=WebView-Clean-101',
  './patches.js?v=WebView-Clean-101',
  './sw-update.js?v=WebView-Clean-101',
  './manifest.json?v=WebView-Clean-101',
  './intro-cross-jesus.jpg?v=WebView-Clean-101',
  './icon-192x192.png',
  './icon-512x512.png',
