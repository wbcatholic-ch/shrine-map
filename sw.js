const CACHE_VERSION = 'catholic-way-WebView-Clean-46';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-46',
  './core.js?v=WebView-Clean-46',
  './style.css?v=WebView-Clean-46',
  './app.js?v=WebView-Clean-46',
  './diocese-meta.js?v=WebView-Clean-46',
  './diocese-search.js?v=WebView-Clean-46',
  './diocese-data.js?v=WebView-Clean-46',
  './diocese-ui.js?v=WebView-Clean-46',
  './web.js?v=WebView-Clean-46',
  './patches.js?v=WebView-Clean-46',
  './sw-update.js?v=WebView-Clean-46',
  './manifest.json?v=WebView-Clean-46',
  './intro-cross-jesus.jpg?v=WebView-Clean-46',
  './icon-192x192.png',
  './icon-512x512.png',
