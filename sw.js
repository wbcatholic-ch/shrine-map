const CACHE_VERSION = 'catholic-way-WebView-Clean-71';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-71',
  './core.js?v=WebView-Clean-71',
  './style.css?v=WebView-Clean-71',
  './app.js?v=WebView-Clean-71',
  './diocese-meta.js?v=WebView-Clean-71',
  './diocese-search.js?v=WebView-Clean-71',
  './diocese-data.js?v=WebView-Clean-71',
  './diocese-ui.js?v=WebView-Clean-71',
  './web.js?v=WebView-Clean-71',
  './patches.js?v=WebView-Clean-71',
  './sw-update.js?v=WebView-Clean-71',
  './manifest.json?v=WebView-Clean-71',
  './intro-cross-jesus.jpg?v=WebView-Clean-71',
  './icon-192x192.png',
  './icon-512x512.png',
