const CACHE_VERSION = 'catholic-way-WebView-Clean-111';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-111',
  './core.js?v=WebView-Clean-111',
  './style.css?v=WebView-Clean-111',
  './app.js?v=WebView-Clean-111',
  './diocese-meta.js?v=WebView-Clean-111',
  './diocese-search.js?v=WebView-Clean-111',
  './diocese-data.js?v=WebView-Clean-111',
  './diocese-ui.js?v=WebView-Clean-111',
  './web.js?v=WebView-Clean-111',
  './patches.js?v=WebView-Clean-111',
  './sw-update.js?v=WebView-Clean-111',
  './manifest.json?v=WebView-Clean-111',
  './intro-cross-jesus.jpg?v=WebView-Clean-111',
  './icon-192x192.png',
  './icon-512x512.png',
