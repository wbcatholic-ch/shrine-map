const CACHE_VERSION = 'catholic-way-WebView-Clean-44';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-44',
  './core.js?v=WebView-Clean-44',
  './style.css?v=WebView-Clean-44',
  './app.js?v=WebView-Clean-44',
  './diocese-meta.js?v=WebView-Clean-44',
  './diocese-search.js?v=WebView-Clean-44',
  './diocese-data.js?v=WebView-Clean-44',
  './diocese-ui.js?v=WebView-Clean-44',
  './web.js?v=WebView-Clean-44',
  './patches.js?v=WebView-Clean-44',
  './sw-update.js?v=WebView-Clean-44',
  './manifest.json?v=WebView-Clean-44',
  './intro-cross-jesus.jpg?v=WebView-Clean-44',
  './icon-192x192.png',
  './icon-512x512.png',
