const CACHE_VERSION = 'catholic-way-WebView-Clean-48';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-48',
  './core.js?v=WebView-Clean-48',
  './style.css?v=WebView-Clean-48',
  './app.js?v=WebView-Clean-48',
  './diocese-meta.js?v=WebView-Clean-48',
  './diocese-search.js?v=WebView-Clean-48',
  './diocese-data.js?v=WebView-Clean-48',
  './diocese-ui.js?v=WebView-Clean-48',
  './web.js?v=WebView-Clean-48',
  './patches.js?v=WebView-Clean-48',
  './sw-update.js?v=WebView-Clean-48',
  './manifest.json?v=WebView-Clean-48',
  './intro-cross-jesus.jpg?v=WebView-Clean-48',
  './icon-192x192.png',
  './icon-512x512.png',
