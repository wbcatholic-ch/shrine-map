const CACHE_VERSION = 'catholic-way-WebView-Clean-81';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-81',
  './core.js?v=WebView-Clean-81',
  './style.css?v=WebView-Clean-81',
  './app.js?v=WebView-Clean-81',
  './diocese-meta.js?v=WebView-Clean-81',
  './diocese-search.js?v=WebView-Clean-81',
  './diocese-data.js?v=WebView-Clean-81',
  './diocese-ui.js?v=WebView-Clean-81',
  './web.js?v=WebView-Clean-81',
  './patches.js?v=WebView-Clean-81',
  './sw-update.js?v=WebView-Clean-81',
  './manifest.json?v=WebView-Clean-81',
  './intro-cross-jesus.jpg?v=WebView-Clean-81',
  './icon-192x192.png',
  './icon-512x512.png',
