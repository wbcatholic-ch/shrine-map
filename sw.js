const CACHE_VERSION = 'catholic-way-WebView-Clean-122';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-122',
  './core.js?v=WebView-Clean-122',
  './style.css?v=WebView-Clean-122',
  './app.js?v=WebView-Clean-122',
  './diocese-meta.js?v=WebView-Clean-122',
  './diocese-search.js?v=WebView-Clean-122',
  './diocese-data.js?v=WebView-Clean-122',
  './diocese-ui.js?v=WebView-Clean-122',
  './web.js?v=WebView-Clean-122',
  './patches.js?v=WebView-Clean-122',
  './sw-update.js?v=WebView-Clean-122',
  './manifest.json?v=WebView-Clean-122',
  './intro-cross-jesus.jpg?v=WebView-Clean-122',
  './icon-192x192.png',
  './icon-512x512.png',
