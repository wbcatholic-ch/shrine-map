const CACHE_VERSION = 'catholic-way-WebView-Clean-96';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-96',
  './core.js?v=WebView-Clean-96',
  './style.css?v=WebView-Clean-96',
  './app.js?v=WebView-Clean-96',
  './diocese-meta.js?v=WebView-Clean-96',
  './diocese-search.js?v=WebView-Clean-96',
  './diocese-data.js?v=WebView-Clean-96',
  './diocese-ui.js?v=WebView-Clean-96',
  './web.js?v=WebView-Clean-96',
  './patches.js?v=WebView-Clean-96',
  './sw-update.js?v=WebView-Clean-96',
  './manifest.json?v=WebView-Clean-96',
  './intro-cross-jesus.jpg?v=WebView-Clean-96',
  './icon-192x192.png',
  './icon-512x512.png',
