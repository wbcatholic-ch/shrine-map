const CACHE_VERSION = 'catholic-way-WebView-Clean-52';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-52',
  './core.js?v=WebView-Clean-52',
  './style.css?v=WebView-Clean-52',
  './app.js?v=WebView-Clean-52',
  './diocese-meta.js?v=WebView-Clean-52',
  './diocese-search.js?v=WebView-Clean-52',
  './diocese-data.js?v=WebView-Clean-52',
  './diocese-ui.js?v=WebView-Clean-52',
  './web.js?v=WebView-Clean-52',
  './patches.js?v=WebView-Clean-52',
  './sw-update.js?v=WebView-Clean-52',
  './manifest.json?v=WebView-Clean-52',
  './intro-cross-jesus.jpg?v=WebView-Clean-52',
  './icon-192x192.png',
  './icon-512x512.png',
