const CACHE_VERSION = 'catholic-way-WebView-Clean-112';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-112',
  './core.js?v=WebView-Clean-112',
  './style.css?v=WebView-Clean-112',
  './app.js?v=WebView-Clean-112',
  './diocese-meta.js?v=WebView-Clean-112',
  './diocese-search.js?v=WebView-Clean-112',
  './diocese-data.js?v=WebView-Clean-112',
  './diocese-ui.js?v=WebView-Clean-112',
  './web.js?v=WebView-Clean-112',
  './patches.js?v=WebView-Clean-112',
  './sw-update.js?v=WebView-Clean-112',
  './manifest.json?v=WebView-Clean-112',
  './intro-cross-jesus.jpg?v=WebView-Clean-112',
  './icon-192x192.png',
  './icon-512x512.png',
