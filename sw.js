const CACHE_VERSION = 'catholic-way-WebView-Clean-108';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-108',
  './core.js?v=WebView-Clean-108',
  './style.css?v=WebView-Clean-108',
  './app.js?v=WebView-Clean-108',
  './diocese-meta.js?v=WebView-Clean-108',
  './diocese-search.js?v=WebView-Clean-108',
  './diocese-data.js?v=WebView-Clean-108',
  './diocese-ui.js?v=WebView-Clean-108',
  './web.js?v=WebView-Clean-108',
  './patches.js?v=WebView-Clean-108',
  './sw-update.js?v=WebView-Clean-108',
  './manifest.json?v=WebView-Clean-108',
  './intro-cross-jesus.jpg?v=WebView-Clean-108',
  './icon-192x192.png',
  './icon-512x512.png',
