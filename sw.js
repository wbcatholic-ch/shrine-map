const CACHE_VERSION = 'catholic-way-WebView-Clean-72';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-72',
  './core.js?v=WebView-Clean-72',
  './style.css?v=WebView-Clean-72',
  './app.js?v=WebView-Clean-72',
  './diocese-meta.js?v=WebView-Clean-72',
  './diocese-search.js?v=WebView-Clean-72',
  './diocese-data.js?v=WebView-Clean-72',
  './diocese-ui.js?v=WebView-Clean-72',
  './web.js?v=WebView-Clean-72',
  './patches.js?v=WebView-Clean-72',
  './sw-update.js?v=WebView-Clean-72',
  './manifest.json?v=WebView-Clean-72',
  './intro-cross-jesus.jpg?v=WebView-Clean-72',
  './icon-192x192.png',
  './icon-512x512.png',
