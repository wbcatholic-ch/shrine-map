const CACHE_VERSION = 'catholic-way-WebView-Clean-73';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-73',
  './core.js?v=WebView-Clean-73',
  './style.css?v=WebView-Clean-73',
  './app.js?v=WebView-Clean-73',
  './diocese-meta.js?v=WebView-Clean-73',
  './diocese-search.js?v=WebView-Clean-73',
  './diocese-data.js?v=WebView-Clean-73',
  './diocese-ui.js?v=WebView-Clean-73',
  './web.js?v=WebView-Clean-73',
  './patches.js?v=WebView-Clean-73',
  './sw-update.js?v=WebView-Clean-73',
  './manifest.json?v=WebView-Clean-73',
  './intro-cross-jesus.jpg?v=WebView-Clean-73',
  './icon-192x192.png',
  './icon-512x512.png',
