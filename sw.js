const CACHE_VERSION = 'catholic-way-WebView-Clean-125';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-125',
  './core.js?v=WebView-Clean-125',
  './style.css?v=WebView-Clean-125',
  './app.js?v=WebView-Clean-125',
  './diocese-meta.js?v=WebView-Clean-125',
  './diocese-search.js?v=WebView-Clean-125',
  './diocese-data.js?v=WebView-Clean-125',
  './diocese-ui.js?v=WebView-Clean-125',
  './web.js?v=WebView-Clean-125',
  './patches.js?v=WebView-Clean-125',
  './sw-update.js?v=WebView-Clean-125',
  './manifest.json?v=WebView-Clean-125',
  './intro-cross-jesus.jpg?v=WebView-Clean-125',
  './icon-192x192.png',
  './icon-512x512.png',
