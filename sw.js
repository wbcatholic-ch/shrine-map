const CACHE_VERSION = 'catholic-way-WebView-Clean-9';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-9',
  './core.js?v=WebView-Clean-9',
  './style.css?v=WebView-Clean-9',
  './app.js?v=WebView-Clean-9',
  './diocese-meta.js?v=WebView-Clean-9',
  './diocese-search.js?v=WebView-Clean-9',
  './diocese-data.js?v=WebView-Clean-9',
  './diocese-ui.js?v=WebView-Clean-9',
  './web.js?v=WebView-Clean-9',
  './patches.js?v=WebView-Clean-9',
  './sw-update.js?v=WebView-Clean-9',
  './manifest.json?v=WebView-Clean-9',
  './intro-cross-jesus.jpg?v=WebView-Clean-9',
  './icon-192x192.png',
  './icon-512x512.png',
