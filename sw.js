const CACHE_VERSION = 'catholic-way-WebView-Clean-20';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-20',
  './core.js?v=WebView-Clean-20',
  './style.css?v=WebView-Clean-20',
  './app.js?v=WebView-Clean-20',
  './diocese-meta.js?v=WebView-Clean-20',
  './diocese-search.js?v=WebView-Clean-20',
  './diocese-data.js?v=WebView-Clean-20',
  './diocese-ui.js?v=WebView-Clean-20',
  './web.js?v=WebView-Clean-20',
  './patches.js?v=WebView-Clean-20',
  './sw-update.js?v=WebView-Clean-20',
  './manifest.json?v=WebView-Clean-20',
  './intro-cross-jesus.jpg?v=WebView-Clean-20',
  './icon-192x192.png',
  './icon-512x512.png',
