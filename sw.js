const CACHE_VERSION = 'catholic-way-WebView-Clean-58';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-58',
  './core.js?v=WebView-Clean-58',
  './style.css?v=WebView-Clean-58',
  './app.js?v=WebView-Clean-58',
  './diocese-meta.js?v=WebView-Clean-58',
  './diocese-search.js?v=WebView-Clean-58',
  './diocese-data.js?v=WebView-Clean-58',
  './diocese-ui.js?v=WebView-Clean-58',
  './web.js?v=WebView-Clean-58',
  './patches.js?v=WebView-Clean-58',
  './sw-update.js?v=WebView-Clean-58',
  './manifest.json?v=WebView-Clean-58',
  './intro-cross-jesus.jpg?v=WebView-Clean-58',
  './icon-192x192.png',
  './icon-512x512.png',
