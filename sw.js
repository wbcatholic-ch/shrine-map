const CACHE_VERSION = 'catholic-way-WebView-Clean-126';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-126',
  './core.js?v=WebView-Clean-126',
  './style.css?v=WebView-Clean-126',
  './app.js?v=WebView-Clean-126',
  './diocese-meta.js?v=WebView-Clean-126',
  './diocese-search.js?v=WebView-Clean-126',
  './diocese-data.js?v=WebView-Clean-126',
  './diocese-ui.js?v=WebView-Clean-126',
  './web.js?v=WebView-Clean-126',
  './patches.js?v=WebView-Clean-126',
  './sw-update.js?v=WebView-Clean-126',
  './manifest.json?v=WebView-Clean-126',
  './intro-cross-jesus.jpg?v=WebView-Clean-126',
  './icon-192x192.png',
  './icon-512x512.png',
