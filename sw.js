const CACHE_VERSION = 'catholic-way-WebView-Clean-119';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-119',
  './core.js?v=WebView-Clean-119',
  './style.css?v=WebView-Clean-119',
  './app.js?v=WebView-Clean-119',
  './diocese-meta.js?v=WebView-Clean-119',
  './diocese-search.js?v=WebView-Clean-119',
  './diocese-data.js?v=WebView-Clean-119',
  './diocese-ui.js?v=WebView-Clean-119',
  './web.js?v=WebView-Clean-119',
  './patches.js?v=WebView-Clean-119',
  './sw-update.js?v=WebView-Clean-119',
  './manifest.json?v=WebView-Clean-119',
  './intro-cross-jesus.jpg?v=WebView-Clean-119',
  './icon-192x192.png',
  './icon-512x512.png',
