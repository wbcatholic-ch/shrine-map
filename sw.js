const CACHE_VERSION = 'catholic-way-WebView-Clean-94';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-94',
  './core.js?v=WebView-Clean-94',
  './style.css?v=WebView-Clean-94',
  './app.js?v=WebView-Clean-94',
  './diocese-meta.js?v=WebView-Clean-94',
  './diocese-search.js?v=WebView-Clean-94',
  './diocese-data.js?v=WebView-Clean-94',
  './diocese-ui.js?v=WebView-Clean-94',
  './web.js?v=WebView-Clean-94',
  './patches.js?v=WebView-Clean-94',
  './sw-update.js?v=WebView-Clean-94',
  './manifest.json?v=WebView-Clean-94',
  './intro-cross-jesus.jpg?v=WebView-Clean-94',
  './icon-192x192.png',
  './icon-512x512.png',
