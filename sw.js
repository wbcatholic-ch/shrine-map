const CACHE_VERSION = 'catholic-way-WebView-Clean-21';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-21',
  './core.js?v=WebView-Clean-21',
  './style.css?v=WebView-Clean-21',
  './app.js?v=WebView-Clean-21',
  './diocese-meta.js?v=WebView-Clean-21',
  './diocese-search.js?v=WebView-Clean-21',
  './diocese-data.js?v=WebView-Clean-21',
  './diocese-ui.js?v=WebView-Clean-21',
  './web.js?v=WebView-Clean-21',
  './patches.js?v=WebView-Clean-21',
  './sw-update.js?v=WebView-Clean-21',
  './manifest.json?v=WebView-Clean-21',
  './intro-cross-jesus.jpg?v=WebView-Clean-21',
  './icon-192x192.png',
  './icon-512x512.png',
