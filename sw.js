const CACHE_VERSION = 'catholic-way-WebView-Clean-51';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-51',
  './core.js?v=WebView-Clean-51',
  './style.css?v=WebView-Clean-51',
  './app.js?v=WebView-Clean-51',
  './diocese-meta.js?v=WebView-Clean-51',
  './diocese-search.js?v=WebView-Clean-51',
  './diocese-data.js?v=WebView-Clean-51',
  './diocese-ui.js?v=WebView-Clean-51',
  './web.js?v=WebView-Clean-51',
  './patches.js?v=WebView-Clean-51',
  './sw-update.js?v=WebView-Clean-51',
  './manifest.json?v=WebView-Clean-51',
  './intro-cross-jesus.jpg?v=WebView-Clean-51',
  './icon-192x192.png',
  './icon-512x512.png',
