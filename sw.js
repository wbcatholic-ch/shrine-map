const CACHE_VERSION = 'catholic-way-WebView-Clean-118';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-118',
  './core.js?v=WebView-Clean-118',
  './style.css?v=WebView-Clean-118',
  './app.js?v=WebView-Clean-118',
  './diocese-meta.js?v=WebView-Clean-118',
  './diocese-search.js?v=WebView-Clean-118',
  './diocese-data.js?v=WebView-Clean-118',
  './diocese-ui.js?v=WebView-Clean-118',
  './web.js?v=WebView-Clean-118',
  './patches.js?v=WebView-Clean-118',
  './sw-update.js?v=WebView-Clean-118',
  './manifest.json?v=WebView-Clean-118',
  './intro-cross-jesus.jpg?v=WebView-Clean-118',
  './icon-192x192.png',
  './icon-512x512.png',
