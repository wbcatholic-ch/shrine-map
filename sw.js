const CACHE_VERSION = 'catholic-way-WebView-Clean-104';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-104',
  './core.js?v=WebView-Clean-104',
  './style.css?v=WebView-Clean-104',
  './app.js?v=WebView-Clean-104',
  './diocese-meta.js?v=WebView-Clean-104',
  './diocese-search.js?v=WebView-Clean-104',
  './diocese-data.js?v=WebView-Clean-104',
  './diocese-ui.js?v=WebView-Clean-104',
  './web.js?v=WebView-Clean-104',
  './patches.js?v=WebView-Clean-104',
  './sw-update.js?v=WebView-Clean-104',
  './manifest.json?v=WebView-Clean-104',
  './intro-cross-jesus.jpg?v=WebView-Clean-104',
  './icon-192x192.png',
  './icon-512x512.png',
