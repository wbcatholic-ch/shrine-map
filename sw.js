const CACHE_VERSION = 'catholic-way-WebView-Clean-97';
const APP_SHELL = [
  './',
  './index.html',
  './constants.js?v=WebView-Clean-97',
  './core.js?v=WebView-Clean-97',
  './style.css?v=WebView-Clean-97',
  './app.js?v=WebView-Clean-97',
  './diocese-meta.js?v=WebView-Clean-97',
  './diocese-search.js?v=WebView-Clean-97',
  './diocese-data.js?v=WebView-Clean-97',
  './diocese-ui.js?v=WebView-Clean-97',
  './web.js?v=WebView-Clean-97',
  './patches.js?v=WebView-Clean-97',
  './sw-update.js?v=WebView-Clean-97',
  './manifest.json?v=WebView-Clean-97',
  './intro-cross-jesus.jpg?v=WebView-Clean-97',
  './icon-192x192.png',
  './icon-512x512.png',
