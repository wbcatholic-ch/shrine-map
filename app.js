...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V2-100';
  }else if(!restore){
...
const _PARISH_ASSET_VERSION='V2-100';
...
const _PRAYER_ASSET_VERSION='V2-100';
...
const _SHRINE_ASSET_VERSION='V2-100';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
    ...
    function renderHome(){
      ...
      if(name && parish){
        ...
        appendRow(
          quick,
          '교구 홈페이지',
          name ? (name + ' 홈페이지') : '내 교구 설정 후 이용할 수 있습니다.',
          '',
          '열기',
        ...
        appendRow(
          quick,
          '교구 사제 찾기',
          name ? (name + ' 사제 찾기') : '내 교구 설정 후 이용할 수 있습니다.',
          '',
          '열기',
