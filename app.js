...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V2-113';
  }else if(!restore){
...
const _PARISH_ASSET_VERSION='V2-113';
...
const _PRAYER_ASSET_VERSION='V2-113';
...
const _SHRINE_ASSET_VERSION='V2-113';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
