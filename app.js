...
function syncCoverUpdateVersionState(){
  try{
    ...
    if(!btn || !box) return;
    var target = btn.getAttribute('data-target-version') || 'V1-S-A47';
    var current = '';
...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V1-S-A47';
  }else if(!restore){
...
const _PARISH_ASSET_VERSION='V1-S-A47';
...
const _PRAYER_ASSET_VERSION='V1-S-A47';
...
const _RETREAT_ASSET_VERSION='V1-S-A47';
...
const _SHRINE_ASSET_VERSION='V1-S-A47';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
