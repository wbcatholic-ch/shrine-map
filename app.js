...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V2-119';
  }else if(!restore){
...
const _PARISH_ASSET_VERSION='V2-119';
...
const _PRAYER_ASSET_VERSION='V2-119';
...
const _SHRINE_ASSET_VERSION='V2-119';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
