...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=WebView-Clean-102';
  }else if(!restore){
...
const _PARISH_ASSET_VERSION='WebView-Clean-102';
...
const _PRAYER_ASSET_VERSION='WebView-Clean-102';
...
const _SHRINE_ASSET_VERSION='WebView-Clean-102';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
