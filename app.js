...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=WebView-Clean-71';
  }else if(!restore){
...
const _PARISH_ASSET_VERSION='WebView-Clean-71';
...
const _PRAYER_ASSET_VERSION='WebView-Clean-71';
...
const _SHRINE_ASSET_VERSION='WebView-Clean-71';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
...
function _hideRouteSheetWhileSearchModalOpen(){
  try{
    ...
    if(!rs || !modal) return;
    if(_activeTab==='route' && (rs.style.display !== 'none')){
