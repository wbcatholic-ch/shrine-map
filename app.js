...
function _parishVisitDioceseField(){return '<div class="shrine-visit-filter-field oai-parish-dio-filter"><span>교구별 <button type="button" data-pv-settings="1" aria-label="나의 본당 자동 방문 기록 설정">⚙</button></span>'+_parishVisitPickerButton('dio',_parishVisitDio==='all'?'전체':_parishVisitDio)+'</div>';}
