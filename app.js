...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V2-159';
  }else if(!restore){
...
const _PARISH_ASSET_VERSION='V2-159';
...
const _PRAYER_ASSET_VERSION='V2-159';
...
const _SHRINE_ASSET_VERSION='V2-159';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
...
(function(){
  // V2-159: Android/WebView에서 키보드가 올라올 때 viewport 높이 축소를
...
(function(){
  ...
  function _isFoldWideMapEdgeBack(start, dx, dy, target){
    // V2-159: Fold 큰 화면 지도에서 시스템 back(popstate)와 JS edge swipe가
