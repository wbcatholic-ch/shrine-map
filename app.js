...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=WebView-Clean-46';
  }else if(!restore){
...
const _PARISH_ASSET_VERSION='WebView-Clean-46';
...
const _PRAYER_ASSET_VERSION='WebView-Clean-46';
...
const _SHRINE_ASSET_VERSION='WebView-Clean-46';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
