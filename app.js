...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V2-143';
  }else if(!restore){
...
const _PARISH_ASSET_VERSION='V2-143';
...
const _PRAYER_ASSET_VERSION='V2-143';
...
const _SHRINE_ASSET_VERSION='V2-143';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
...
(function(){
  // V2-143: Android/WebView에서 키보드가 올라올 때 viewport 높이 축소를
